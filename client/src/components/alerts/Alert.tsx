...
const Alert = ({
    ...
    return (
        <div
            className="flex items-center justify-items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:text-red-400"
            role="alert"
        >
            <svg
            ...
            <div className="mr-3 text-sm font-medium w-full">{message}</div>
